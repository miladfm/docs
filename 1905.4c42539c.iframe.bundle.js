"use strict";(self.webpackChunkcocokits=self.webpackChunkcocokits||[]).push([[1905],{"./node_modules/.pnpm/@mdx-js+react@3.0.1_@types+react@18.3.8_react@18.2.0/node_modules/@mdx-js/react/lib/index.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{R:()=>useMDXComponents,x:()=>MDXProvider});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/.pnpm/react@18.2.0/node_modules/react/index.js"),react__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);const emptyComponents={},MDXContext=react__WEBPACK_IMPORTED_MODULE_0___default().createContext(emptyComponents);function useMDXComponents(components){const contextComponents=react__WEBPACK_IMPORTED_MODULE_0___default().useContext(MDXContext);return react__WEBPACK_IMPORTED_MODULE_0___default().useMemo((function(){return"function"==typeof components?components(contextComponents):{...contextComponents,...components}}),[contextComponents,components])}function MDXProvider(properties){let allComponents;return allComponents=properties.disableParentContext?"function"==typeof properties.components?properties.components(emptyComponents):properties.components||emptyComponents:useMDXComponents(properties.components),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(MDXContext.Provider,{value:allComponents},properties.children)}},"./packages/internal/storybook-doc-page/src/index.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{ws:()=>MdxCssSelectorTable,Nk:()=>MdxDocPage,r:()=>MdxTokenTable});var jsx_runtime=__webpack_require__("./node_modules/.pnpm/react@18.2.0/node_modules/react/jsx-runtime.js"),styled_components_browser_esm=__webpack_require__("./node_modules/.pnpm/styled-components@6.1.13_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/styled-components/dist/styled-components.browser.esm.js"),DocCategory=__webpack_require__("./packages/internal/storybook-doc-page/src/lib/components/doc-page/DocCategory.tsx"),DocPage=__webpack_require__("./packages/internal/storybook-doc-page/src/lib/components/doc-page/DocPage.tsx"),DocToc=__webpack_require__("./packages/internal/storybook-doc-page/src/lib/components/doc-page/DocToc.tsx");const MdxDocPage=({children,groupTitle,toc,utilsPage,hideCckThemeSwitcher=!1})=>(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsx)(DocPage.w,{hideCckThemeSwitcher,utilsPage,children:(0,jsx_runtime.jsxs)(StyledWrapper,{children:[(0,jsx_runtime.jsxs)(StyledMain,{children:[groupTitle&&(0,jsx_runtime.jsx)(DocCategory.j,{children:groupTitle}),children]}),toc&&toc.length>0&&(0,jsx_runtime.jsx)(DocToc.H,{items:toc})]})})}),StyledWrapper=styled_components_browser_esm.Ay.div`
    display: flex;
    position: relative;
    width: 100%;
    margin: auto;
`,StyledMain=styled_components_browser_esm.Ay.main`
    flex: 1;
    display: flex;
...
`,StyledTableName=styled_components_browser_esm.Ay.div`
    ...
    min-height: 40px;
`}}]);
//# sourceMappingURL=1905.4c42539c.iframe.bundle.js.map